...
const sanitizeMeetingTimes = (
  meetingDate,
  startTime,
  endTime,
  safeInfo = getSafeNowInfo()
) => {
...
export default function CreateDepartmentCalendarPage() {
  ...
  useEffect(() => {
    const loadMembers = async () => {
      ...
      try {
        const res = await departmentService.getMembersByDepartment(
          eventId,
          departmentId
        );
        setMembersList(res || []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await calendarService.createCalendarForDepartment(
        eventId,
        departmentId,
        submitData
      );
...
<form onSubmit={handleSubmit}>
            ...
            >
              ...
              >
                ...
                <div
                  style={{ marginBottom: "12px", display: "flex", gap: "20px" }}
                >
                  <label
                    style={{
                      display: "flex",
