    ...
    <div className="container-xl px-2 py-5 py-md-5">
      <div className="text-center mb-5">
        ...
        <p className="text-secondary" style={{ fontSize: 15, lineHeight: 1.7 }}>
          Nếu bạn có thắc mắc hoặc muốn hợp tác, hãy gửi tin nhắn cho chúng tôi nhé!
        </p>
      </div>
              ...
              <div className="d-flex flex-column gap-3">
                <div className="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-secondary" style={{ fontSize: 14, lineHeight: 1.6 }}>Phòng DE412, Tòa nhà Delta, Đại học FPT, Hà Nội</div>
                  </div>
                </div>
                <div className="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-secondary" style={{ fontSize: 14 }}>nookhanhtungf5@gmail.com</div>
                  </div>
                </div>
                <div className="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-secondary" style={{ fontSize: 14 }}>039 822 6650</div>
                  </div>
                </div>
                <div className="d-flex gap-3">
