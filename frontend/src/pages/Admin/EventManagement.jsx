                ...
                >
                  ...
                  >
                    {!event.eventStartDate
                      ? "Không rõ"
                      : event.eventEndDate
                      ? `${formatDate(event.eventStartDate)} - ${formatDate(
                          event.eventEndDate
                        )}`
                  ...
                  <td style={{ padding: "16px" }}>
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          navigate(`/admin/event-management/${event._id}`);
                        }}
                        style={{
                          padding: "4px",
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              ...
              >
                <ChevronLeft
                  style={{ width: "16px", height: "16px", color: "#616161" }}
                />
              </button>
                ...
                (pageNum) => (
                  <button
                    ...
                    style={{
                      padding: "8px 12px",
                      backgroundColor:
                        currentPage === pageNum ? "#2196F3" : "#FFFFFF",
    ...
    {selectedEvent && (
      <BanEventModal
        ...
        eventData={{
          ...
          hooc:
            selectedEvent.members?.[0]?.userId?.fullName ?? "Không xác định",
          date: selectedEvent.eventStartDate
            ? selectedEvent.eventEndDate
              ? `${formatDate(selectedEvent.eventStartDate)} - ${formatDate(
                  selectedEvent.eventEndDate
                )}`
