    ...
    <div className="d-flex align-items-center justify-content-center py-5" style={{ minHeight: '100vh' }}>
      <div className="container text-center">
        <div className="d-flex justify-content-center mb-3">
          <img src={error502} alt="504 illustration" style={{ width: '80%', maxWidth: 420 }} />
        </div>
        <div className="display-1 fw-bold">504</div>
        <div className="h4 fw-bold">ERROR - Gateway Timeout</div>
