...
const generateErrorId = () => {
  return 'ERR-503-' + Math.random().toString(36).substr(2, 9).toUpperCase();
};
...
export default function ErrorPage503() {
  ...
  // Lưu thông tin lỗi vào useMemo để không bị đổi khi re-render
  ...
  return (
    <div className="d-flex align-items-center justify-content-center py-5" style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      <div className="container text-center">
        ...
        {/* Error Title */}
        <div className="display-1 fw-bold text-warning">503</div>
        <div className="h4 fw-bold mb-3">ERROR - Service Unavailable</div>

        {/* Friendly Message */}
        <p className="text-secondary mx-auto mb-4" style={{ maxWidth: 600, lineHeight: '1.6' }}>
          Hệ thống đang bảo trì hoặc quá tải tạm thời.<br />
        ...
        <div className="text-secondary mt-4 small">
          Gửi <a className="text-decoration-none fw-bold" href={`mailto:support@myfevent.com?subject=Report 503 Error ${errorInfo.id}`}>email</a> hoặc kết nối qua Mạng Xã Hội với chúng tôi.
        </div>
...
// Component phụ render icon MXH (Có thể tách ra file riêng nếu dùng chung nhiều nơi)
